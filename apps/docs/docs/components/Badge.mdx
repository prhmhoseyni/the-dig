...
| `...rest` | `HTMLAttributes<HTMLDivElement>` (e.g. `onClick`, `disabled`, etc.)           | <RedirectLink href="https://developer.mozilla.org/en-US/docs/Web/API/HTMLElement">Document</RedirectLink> |
