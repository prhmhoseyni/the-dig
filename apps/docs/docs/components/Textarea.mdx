...
| Others           | `TextareaHTMLAttributes<HTMLTextAreaElement>` | <RedirectLink href="https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/textarea">Document</RedirectLink> |
