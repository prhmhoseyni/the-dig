...
<Button variant="tinded" color="danger" isLoading={isLoading} loadingPosition="start" isShowAdornmentLoading={isLoading} startIcon={<BadgeCheck size={18} />}>
    ثبت
</Button>
<Button variant="contained" color="danger" isLoading={isLoading} loadingPosition="end" isShowAdornmentLoading={isLoading} endIcon={<BadgeCheck size={18} />}>
    پرداخت
</Button>
