...
export default function ChipPage() {
  return (
    <>
      ...
      <div className="flex items-center gap-4 p-4">
        <Chip color="brand">Chip Label</Chip>
        <Chip color="info">Chip Label</Chip>
        <Chip color="success">Chip Label</Chip>
        <Chip color="danger">Chip Label</Chip>
        <Chip color="warning">Chip Label</Chip>
        <Chip color="gray">Chip Label</Chip>
      </div>
    </>
  );
}
