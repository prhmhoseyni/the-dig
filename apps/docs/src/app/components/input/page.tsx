    ...
    return (
        <>
            ...
            <div className="flex flex-col gap-4 p-8">
                ...
                <Input type="text" variant="secondary" placeholder="Enter the information..." startAdornment={<Activity size={15} />} endAdornment={<Activity size={15} />} />
                <Input type="text" variant="secondary" hasError placeholder="Enter the information..." startAdornment={<Activity size={15} />} endAdornment={<Activity size={15} />} />
            </div>
        </>
    )
}